...
impl MockDataStore {
    pub fn new() -> Self {
        ...
        rooms.insert("room1".to_string(), MeetingRoomItem {
        ...
        rooms.insert("room2".to_string(), MeetingRoomItem {
...
pub fn setup_mock_client() -> (MockTencentMeetingClient, Arc<MockDataStore>) {
    ...
    mock_client.expect_create_meeting()
